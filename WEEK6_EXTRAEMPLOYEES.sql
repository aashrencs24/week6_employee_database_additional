...
WHERE MGR_NO IS NULL
  AND 2 = (
    ...
    FROM EMPLOYEE E2
    WHERE E2.DEPTNO = E1.DEPTNO AND E2.SAL > E1.SAL AND E2.MGR_NO IS NULL
  );
...
select p.pname, count(*) as headcount from project p, assigned_to a
where p.pno = a.pno group by p.pname;
